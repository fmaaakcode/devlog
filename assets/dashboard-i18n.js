...
export const DICT = {
  ...
  "vuln.nothing": { en: "No libraries or runtime to scan", ar: "لا توجد مكتبات أو runtime لفحصها" },
  ...
  "lib.sevPart": { en: " — severity: {sev}", ar: " — خطورة: {sev}" },
  "lib.clickSuffix": { en: " — click for details", ar: " — اضغط للتفاصيل" },
  "lib.outdated": { en: "Outdated library", ar: "مكتبة قديمة" },
