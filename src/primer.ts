...
- \`-(note)\` observation · \`-(decision)\` architectural decision — name the rejected alternative and why it lost; a trade-off study wider than one line belongs in \`-(doc:comparison)\` · \`-(insight)\` root cause
...
- \`-(note)\` ملاحظة · \`-(decision)\` قرار معماري — سمِّ البديل المرفوض وسبب رفضه؛ والموازنة الأوسع من سطر بيتها \`-(doc:comparison)\` · \`-(insight)\` جذر مشكلة
